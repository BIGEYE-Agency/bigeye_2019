...
if ( ! function_exists( 'twentysixteen_post_thumbnail' ) ) :
	...
	function twentysixteen_post_thumbnail() {
		...
		//print $yoast_title;
			//print( '<pre>%s</pre>', print_r( apply_filters( 'the_title', $title ) , 0 ) );//the_post_thumbnail(); ?>
			<?php the_post_thumbnail( 'post-thumbnail', array( 'alt' => get_post_meta($post_id, '_yoast_wpseo_focuskw', true),'title' => the_title_attribute( 'echo=0' ) ) ); ?>
	</div><!-- post-thumbnail -->
