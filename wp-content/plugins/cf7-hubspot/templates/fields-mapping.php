...
<input type="text" name='meta[map][<?php echo $k?>][value]'  id="vx_value_<?php echo $k ?>" value='<?php echo $this->post2($k,'value',$map)?>' placeholder='<?php _e("Custom Value",'contact-form-hubspot-crm')?>' class='vx_input_100 vxc_field_input'>
...
<input type="text" name='value'  id="vx_value_" placeholder='<?php _e("Custom Value",'contact-form-hubspot-crm')?>' class='vx_input_100 vxc_field_input'>
<div class="howto"><?php echo sprintf(__('You can add a form field %s in custom value from following form fields','contact-form-hubspot-crm'),'<code>{field_id}</code>')?></div>
</div>
...
if($module == 'Ticket'){
$pipes=$this->post('pipes',$info_meta);
 ?>
    <div class="vx_div vx_refresh_panel ">    
      <div class="vx_head ">
...
<div class="clear"></div>
  ...
  <div class="vx_col2">
  <button class="button vx_refresh_data" data-id="refresh_pipes" type="button" autocomplete="off" style="vertical-align: baseline;">
  <span class="reg_ok"><i class="fa fa-refresh"></i> <?php _e('Refresh Data','contact-form-hubspot-crm') ?></span>
  <span class="reg_proc"><i class="fa fa-refresh fa-spin"></i> <?php _e('Refreshing...','contact-form-hubspot-crm') ?></span>
  </button>
  </div> 
